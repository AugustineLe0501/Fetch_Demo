...
class Arm:
    ...
    def MoveToPose(self,X,Y,Z,Roll,Pitch,Yaw):
        ...
        self.moveGroup.moveToPose(self.poseStamped, 'gripper_link',0.005, max_velocity_scaling_factor = 0.2)
    ...
    def Tuck(self):
        ...
        self.moveGroup.moveToJointPosition(joints, pose, 0.01, max_velocity_scaling_factor = 0.2)
